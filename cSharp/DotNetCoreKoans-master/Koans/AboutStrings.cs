...
broken line";
        ...
        {
            var str = string.Format(new System.Globalization.CultureInfo("en-US"), "{0:n}", 123456);
        ...
        {
            var str = string.Format(new System.Globalization.CultureInfo("en-US"), "{0:c}", 123456);
            Assert.Equal("$123,456.00", str);
        }
        ...
        {
            var str = string.Format(new System.Globalization.CultureInfo("en-US"), "{0:.##}", 12.3456);
